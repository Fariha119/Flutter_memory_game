...
List<TileModel> iPairs = <TileModel>[];
List<bool> clicked = <bool>[];

List<bool> getClicked(){

  List<bool> iClicked = <bool>[];
...
List<TileModel>  getPairs(){
  ...
  //9
  tileModel.setImageAssetPath("assets/9.png");
  tileModel.setIsSelected(false);
  pairs.add(tileModel);
  pairs.add(tileModel);
  tileModel = new TileModel();
  ...
  //10
  tileModel.setImageAssetPath("assets/10.png");
  tileModel.setIsSelected(false);
  pairs.add(tileModel);
  pairs.add(tileModel);
  tileModel = new TileModel();
